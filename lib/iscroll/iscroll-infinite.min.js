!function (t, i, e) {
    ...
    var n = t.requestAnimationFrame || t.webkitRequestAnimationFrame || t.mozRequestAnimationFrame || t.oRequestAnimationFrame || t.msRequestAnimationFrame || function (i) {
        ...
        var n = {}, o = i.createElement("div").style, h = function () {
            for (var t, i = ["t", "webkitT", "MozT", "msT", "OT"], e = 0, s = i.length; s > e; e++)if (t = i[e] + "ransform", t in o)return i[e].substr(0, i[e].length - 1);
            return !1
        }();
    ...
    s.prototype = {
        version: "5.2.0", _init: function () {
            ...
            if (this.enabled && o.eventType[t.type] === this.initiated) {
                ...
                var i, s, n, h, r = t.touches ? t.touches[0] : t, a = r.pageX - this.pointX, l = r.pageY - this.pointY, c = o.getTime();
            ...
            if (this.enabled && o.eventType[t.type] === this.initiated) {
                ...
                var i, s, n = (t.changedTouches ? t.changedTouches[0] : t, o.getTime() - this.startTime), h = e.round(this.x), r = e.round(this.y), a = e.abs(h - this.startX), l = e.abs(r - this.startY), c = 0, p = "";
            ...
            if (this._events[t]) {
                ...
                if (e)for (; e > i; i++)this._events[t][i].apply(this, [].slice.call(arguments, 1))
            }
            ...
            this.currentPage = {}, "string" == typeof this.options.snap && (this.options.snap = this.scroller.querySelectorAll(this.options.snap)), this.on("refresh", function () {
                var t, i, s, n, o, h, r = 0, a = 0, l = 0, c = this.options.snapStepX || this.wrapperWidth, p = this.options.snapStepY || this.wrapperHeight;
                if (this.pages = [], this.wrapperWidth && this.wrapperHeight && this.scrollerWidth && this.scrollerHeight) {
                    if (this.options.snap === !0)for (s = e.round(c / 2), n = e.round(p / 2); l > -this.scrollerWidth;) {
                        ...
                        l -= c, r++
                    } else for (h = this.options.snap, t = h.length, i = -1; t > r; r++)(0 === r || h[r].offsetLeft <= h[r - 1].offsetLeft) && (a = 0, i++), this.pages[a] || (this.pages[a] = []), l = e.max(-h[r].offsetLeft, this.maxScrollX), o = e.max(-h[r].offsetTop, this.maxScrollY), s = l - e.round(h[r].offsetWidth / 2), n = o - e.round(h[r].offsetHeight / 2), this.pages[a][i] = {
                        x: l,
                        y: o,
            ...
            var s = 0, n = this.pages.length, o = 0;
            if (e.abs(t - this.absStartX) < this.snapThresholdX && e.abs(i - this.absStartY) < this.snapThresholdY)return this.currentPage;
            for (t > 0 ? t = 0 : t < this.maxScrollX && (t = this.maxScrollX), i > 0 ? i = 0 : i < this.maxScrollY && (i = this.maxScrollY); n > s; s++)if (t >= this.pages[s][0].cx) {
                t = this.pages[s][0].x;
                break
            }
            for (n = this.pages[s].length; n > o; o++)if (i >= this.pages[0][o].cy) {
                i = this.pages[0][o].y;
                break
            }
            ...
            var o = this.pages[t][i].x, h = this.pages[t][i].y;
            ...
            if (this.enabled) {
                var i, s = this.options.snap, n = s ? this.currentPage.pageX : this.x, h = s ? this.currentPage.pageY : this.y, r = o.getTime(), a = this.keyTime || 0, l = .25;
            ...
            var r = this, a = this.x, l = this.y, c = o.getTime(), p = c + e;
            ...
            if (void 0 !== this.infiniteCache)for (var i = 0, e = t.length; e > i; i++)this.options.dataFiller.call(this, t[i], this.infiniteCache[t[i]._phase])
